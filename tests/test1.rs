...
// Use prelude to get Øll the necessary imports
use cw_orch::{
    anyhow,
...
fn setup() -> anyhow::Result<(
    ...
    let sender = Addr::unchecked("wyndex_owner");
    // let app = AppInterface::new(APP_ID, daemon.clone());
    let queryValue = app.query::<msg::AppQueryMsg>(&QueryMsg::Module(msg::AppQueryMsg::Config {}));
    // let exec = app.execute(ExecuteMsg)
